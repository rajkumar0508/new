                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  @foreach($data as $va=>$key)
                    <tr>
                      ...
                      <td>
                         <a href="{{ URL::route('course.edit',$key['id']) }}"> <button type="button" class="btn btn-success" >Edit</button></a>
                          <form action="{{ URL::route('course.destroy',$key['id'])}}" class="d-inline-block" method="post" id="company_delete_{{ $key['id'] }}">
