...
<!-- Nav Item - Tables -->
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ URL::to('admin/course/create') }}">Create</a>
          <a class="collapse-item" href="{{ URL::to('admin/course') }}">List</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="{{ URL::to('admin/lessions/create') }}">Create</a>
          <a class="collapse-item" href="{{ URL::to('admin/lessions') }}">List</a>
        </div>
      </div>
    </li>
